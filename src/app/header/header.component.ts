...
export class HeaderComponent implements OnInit, OnDestroy {
    ...
    public employeeId: any = sessionStorage.getItem('employeeId');
    public colorObj: any = {
    ...
    constructor(
        ...
        this.isValid = this.authUserService.isLoggedIn();
    }
    ...
    ngOnInit() {
        ...
        this.authUserService.bSubject.subscribe((value: any) => {
            console.log("Subscription got", value);
            this.nfCount += value == 'default' ? 0 : Number(value);
        });

        // this.authUserService.getNotifications().subscribe(async (response: any) => {
    ...
    getSessionTime() {
        ...
        if (this.authUserService.isLoggedIn() || this.isValid) {
    ...
    reSignIn() {
        ...
        console.log('Post payload to get employee reSignIn data isss', tokenPayload);

        this.authUserService.userReSignIn(tokenPayload).subscribe(async (response: any) => {
            console.log('Get employee reSignIn data response isss', response);
